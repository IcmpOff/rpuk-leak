Locales['en'] = {
  ...
  ['gave_item'] = 'you gave %s x %s to a player',
  ['received_item'] = 'you received %sx %s from a player',
  ['gave_weapon'] = 'you gave %s to a player',
  ['gave_weapon_ammo'] = 'you gave %s x %s for %s to a player',
  ['gave_weapon_withammo'] = 'you gave %s with %sx %s to a player',
  ['gave_weapon_hasalready'] = 'the player already has a %s',
  ['gave_weapon_noweapon'] = 'the player does not have that weapon',
  ['received_weapon'] = 'you received %s from a player',
  ['received_weapon_ammo'] = 'you received %sx %s for your %s from a player',
  ['received_weapon_withammo'] = 'you received %s with %sx %s from a player',
  ['received_weapon_hasalready'] = 'a player attempted to give you a %s, but you already have one',
  ['received_weapon_noweapon'] = 'a player attempted to give you ammo for a %s, but you dont have one',
  ['gave_account_money'] = 'you gave £%s (%s) to a player',
  ['received_account_money'] = 'you received £%s (%s) from a player',
  ['amount_invalid'] = 'invalid amount',
  ['players_nearby'] = 'no players nearby',
  ['ex_inv_lim'] = 'action not possible, exceeding inventory limit for that player',
  ...
  ['threw_weapon_ammo'] = 'you threw %s with %s x %s',
  ...
  ['command_obj_spawn'] = 'spawn a object',
  ['command_car_car'] = 'vehicle spawn name or hash',
  ['command_obj_spawn_help'] = 'object spawn name or hash',
  ...
  ['command_clearammo'] = "clear a players ammo",
  ...
  ['commanderror_argumentmismatch_number_min'] = 'argument #%s is under minimum allowed value',
  ['commanderror_argumentmismatch_number_max'] = 'argument #%s is above maximum allowed value',
  ...
  ['command_giveammo'] = "ammo type (pistol | shotgun | smg | assaultRifle | lmg | sniper | petrol)",
  ['commanderror_invalidammo'] = "not a valid ammotype",
