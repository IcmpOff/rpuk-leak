...
--yes the chip stacks are actually TWELVE chips per stack, not TEN, but ignore that for now... sink 'em later.
chipModels = {
	[10] = "vw_prop_chip_10dollar_x1",
	[50] = "vw_prop_chip_50dollar_x1",
	[100] = "vw_prop_chip_100dollar_x1",
--	[100] = "vw_prop_chip_10dollar_st", --was 120
	[500] = "vw_prop_chip_500dollar_x1",
--	[500] = "vw_prop_chip_50dollar_st", --was 600
	[1000] = "vw_prop_chip_1kdollar_x1",
--	[1000] = "vw_prop_chip_100dollar_st", --was 1200
	[5000] = "vw_prop_chip_5kdollar_x1",
--	[5000] = "vw_prop_chip_500dollar_st", --was 6000
	[10000] = "vw_prop_chip_10kdollar_x1",
	[50000] = "vw_prop_chip_5kdollar_st", --was 60000
	[100000] = "vw_prop_chip_10kdollar_st", --was 120000
}
...
splitMultipliers = { -- used for calculating two-handed bet payouts
	["natural"] = {
		2.5,
		2.25,
		1.75,
...
function SetDealerVoice(ped, index)
	...
	SetPedVoiceGroup(ped, FemaleDealerVoices[index])
