...
function ApplySkin(skin, clothes, entityHandle)
	...
	SetPedHeadOverlay			(playerPed, 3,		math.floor(Character['age_1']),				(Character['age_2']) + 0.0)				-- Age + opacity
	SetPedHeadOverlay			(playerPed, 1,		math.floor(Character['beard_1']),			(Character['beard_2']) + 0.0)			-- Beard + opacity
	SetPedEyeColor				(playerPed,			Character['eye_color'], 0, 1)												-- Eyes color
	SetPedHeadOverlay			(playerPed, 2,		math.floor(Character['eyebrows_1']),		(Character['eyebrows_2']) + 0.0)		-- Eyebrows + opacity
	SetPedComponentVariation	(playerPed, 2,		Character['hair_1'],			0, 2)						-- Hair
	...
	SetPedHeadOverlayColor(PlayerPedId(), 4, 2, Character['makeup_3'], Character['makeup_4'])
	SetPedHeadOverlay(PlayerPedId(), 8, Character['lipstick_1'], Character['lipstick_2'])
	SetPedHeadOverlayColor(PlayerPedId(), 8, 2, Character['lipstick_3'], Character['lipstick_4'])
